...
const ReleaseUrl = "https://api.github.com/repos/AToska21/VencordUser/releases/latest"
const ReleaseUrlFallback = "https://vencord.dev/releases/vencord"
const InstallerReleaseUrl = "https://api.github.com/repos/AToska21/VencordUserInstaller/releases/latest"
const InstallerReleaseUrlFallback = "https://vencord.dev/releases/installer"

var UserAgent = "VencordUserInstaller/" + buildinfo.InstallerGitHash + " (https://github.com/AToska21/VencordUserInstaller)"
